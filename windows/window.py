...
def clientWindow():
    ...
    clientsInformations.column('Horário', width=50)
    ...
    client_register_buttom = Button(client_window, text="Cadastrar", width=20, height=4, border=5)
